...
# Import prediction asset for dependency reference
...
@asset(
    ...
    deps=[generate_game_predictions],  # Depends on predictions
    automation_condition=AutomationCondition.eager(),  # Run when predictions update
)
